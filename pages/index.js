      ...
      <div className="container mx-auto mb-10">
        ...
        <div className="laptop:mt-20 mt-10">
          <div className="mt-5">
            <h1
              ref={textOne}
              className="text-3xl tablet:text-6xl laptop:text-7xl laptopl:text-6xl p-1 tablet:p-2 text-bold w-4/5 mob:w-full laptop:w-4/5"
            >
        ...
        <div className="mt-10 laptop:mt-30 p-2 laptop:p-0" ref={mediaRef}>
          <h1 className="text-3xl text-bold">TMZ takin pictures, causin mad hysteria:</h1>
          <div className="mt-5 laptop:mt-10 grid grid-cols-1 tablet:grid-cols-2 gap-4">
